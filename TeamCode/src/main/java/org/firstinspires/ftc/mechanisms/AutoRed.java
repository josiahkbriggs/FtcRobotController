...
@Autonomous
(name="Josiah's Success Red", preselectTeleOp="Linear Opmode")
   ...
   // Tells the code what an hardware object is
    ...
    public void runOpMode() {
        ...
        imu = hardwareMap.get(IMU.class, "imu");
            ...
            LFront.setTargetPositionTolerance(10);
            RFront.setTargetPositionTolerance(10);
            LBack.setTargetPositionTolerance(10);
            RBack.setTargetPositionTolerance(10);
